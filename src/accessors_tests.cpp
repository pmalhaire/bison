...
void accessor_int32() {
    std::vector<char> int_v = {'i',    'n',    't',    '3',    '2',
                               '\x00', '\x01', '\x00', '\x00', '\x00'};
...
void accessor_int64() {
    std::vector<char> int_v = {'i',    'n',    't',    '6',    '4',
                               '\x00', '\x03', '\x00', '\x00', '\x00',
                               '\x00', '\x00', '\x00', '\x00'};
    vect_it buff = int_v.begin();
...
void accessor_uint64() {
    std::vector<char> int_v = {'u',    'i',    'n',    't',    '6',
                               '4',    '\x00', '\x00', '\x00', '\x00',
                               '\x00', '\x00', '\x02', '\x00', '\x00'};
    vect_it buff = int_v.begin();
...
void accessor_string() {
    std::vector<char> int_v = {'s',    't',    'r',    'i',    'n',    'g',
                               '\x00', '\x07', '\x00', '\x00', '\x00', 's',
                               't',    'r',    'i',    'n',    'g',    '\x00'};
    vect_it buff = int_v.begin();
...
void accessor_cstring() {
    std::vector<char> int_v = {'s', 't', 'r', 'i', 'n', 'g', '\x00',
                               's', 't', 'r', 'i', 'n', 'g', '\x00'};
    vect_it buff = int_v.begin();
...
void accessor_doc() {
    std::vector<char> int_v = {'\x16', '\x00', '\x00', '\x00', '\x02', 'h',
                               'e',    'l',    'l',    'o',    '\x00', '\x06',
                               '\x00', '\x00', '\x00', 'w',    'o',    'r',
                               'l',    'd',    '\x00', '\x00'};
    vect_it buff = int_v.begin();
